...
$result = "select *,  date_format(age_data,'%d/%m/%Y') as data
                ...
                where a.tpg_codigo=6
                    and a.cli_codigo like  '" . $clientes . "'
                    and a.tps_codigo like '" . $servicos . "'
                    and a.sta_codigo like '2'";
...
if (($resultado) and ($resultado->num_rows != 0)) {
    while ($row = mysqli_fetch_assoc($resultado)) {
        if ($row['sta_codigo'] == 2) {
            ...
            ";
        } /*else if ($row['sta_codigo'] == 3) {
            echo "
        <input type='hidden' name='id_pagamento[]' value='" . $row['age_codigo'] . "' id='txt_atualizar_codigo_pagamento_pendente" . $row['age_codigo'] . "'>
            <div class='row'>
                <div class='form-group' style='padding-right: 8px; padding-left:4vh;'>
                    <select class='form-control' style='width: 44vh;' readonly name='txt_atualizar_cliente_pagamento_pendente' id='txt_atualizar_cliente_pagamento_pendente'>
                    <option value='" . $row['cli_codigo'] . "' selected> " . $row['cli_nome'] . "</option>
                    </select>
                </div>
                <div class='form-group' style='padding-right: 8px;'>
                    <select class='form-control' style='width: 26vh;' readonly name='txt_atualizar_servico_pagamento_pendente' id='txt_atualizar_servico_pagamento_pendente'>
                    <option value='" . $row['tps_codigo'] . "'selected>" . $row['tps_descricao'] . "</option>
                    </select>
                </div>
                <div class='form-group' style='padding-right: 8px;'>
                    <input type='text' value='" . $row['data'] . "' readonly style='width: 17vh;' name='txt_atualizar_data_pagamento_pendente' class='form-control' id='txt_atualizar_data_pagamento_pendente'>
                </div>
                <div class='form-group' style='padding-right: 8px;'>
                    <div class='bootstrap-timepicker'>
                        <select class='form-control' style='width: 15vh;' readonly name='txt_atualizar_horario_pagamento_pendente' id='txt_atualizar_horario_pagamento_pendente' style='width: 100%;'>
                ...
                <div class='form-group' style='padding-right: 8px;'>
                    <input type='text' style='width: 13vh;' readonly value='" . number_format($row['age_preco'], 2, ',', '') . "' class='form-control' name='txt_atualizar_preco_pagamento_pendente' id='txt_atualizar_preco_pagamento_pendente' placeholder='Valor (Ex: 10,00)'>
                </div>
                <div class='form-group' style='padding-right: 8px;'>
                    <select class='form-control' style='width: 23vh;'  name='status_pagamento[" . $row['age_codigo'] . "]' id='txt_atualizar_status_pagamento_pendente" . $row['age_codigo'] . "' style='width: 100%;'>
                ...
                <div class='form-group' style='padding-right: 8px;'>
                    <select class='form-control' name='valor_pagamento[" . $row['age_codigo'] . "]' id='txt_atualizar_tipopgto_pagamento_pendente" . $row['age_codigo'] . "' style='width:20vh;'>

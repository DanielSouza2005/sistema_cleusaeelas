    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Clientes / <small>Edição</small> </h1>
            </div>
            <div class="col-sm-6">
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form method="post" action="atualizar_cliente.php" name="frm_cliente" id="frm_cliente">
                        ...
                        <div class="row" style="padding-bottom: 0vh">
                          <div class="card-body " style="padding-bottom: 0vh;">
                            <div class="form-group" style="margin-bottom: 0vh">
                              ...
                              <input type="text" name="txt_nome" maxlength="80" class="form-control" value="<?php echo $dados['cli_nome']; ?>" id="exampleInputPassword1" placeholder="Digite o Nome">
                            </div>
                          </div>
                        </div>
                        <div class="row">
                          <div class="card-body " style="padding-bottom: 0vh;">
                            <input type="hidden" name="txt_codigo" value="<?php echo $dados['cli_codigo']; ?>" id="exampleInputPassword1">
                            <div class="form-group">
                              <label for="exampleInputEmail1">Email</label>
                              <input type="email" name="txt_email" maxlength="80" class="form-control" value="<?php echo $dados['cli_email']; ?>" id="exampleInputEmail1" placeholder="Digite o Email">
                            </div>
                            <div class="form-group">
                              ...
                              <select class="form-control" name="txt_sexo" id="txt_sexo" style="width: 100%;">
                                ...
                                <option value="N" <?php if($dados['cli_sexo'] == 'N') echo "selected";?>>Não Binário</option>
                                <option value="O" <?php if($dados['cli_sexo'] == 'O') echo "selected";?>>Outro</option>
                                <option value="I" <?php if($dados['cli_sexo'] == 'I') echo "selected";?>>Prefiro não Informar</option>
                          ...
                          <div class="card-body " style="padding-bottom: 0vh;">
                            <div class="form-group">
                              ...
                              <input type="text" name="txt_celular" class="form-control" value="<?php echo $dados['cli_celular']; ?>" id="exampleInputPhone" placeholder="Digite o Celular" data-inputmask='"mask": "(99) 99999-9999"' data-mask>
                            </div>
                            <div class="form-group">
                              <label for="exampleInputEmail1">Data da Nascimento</label>
                              <input type="date" name="txt_data_nascimento" class="form-control" value="<?php echo $dados['cli_data_nascimento']; ?>" id="exampleInputDateofBirth">
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="card-footer" style="background-color: white; padding-left:4vh; padding-top:0vh; padding-bottom:2.5vh;">
                    <button type="submit" class="btn btn-primary" onclick="return validar_dados()">Editar</button>
                  </div>
                </form>
              </div>
              <!-- /.card -->
